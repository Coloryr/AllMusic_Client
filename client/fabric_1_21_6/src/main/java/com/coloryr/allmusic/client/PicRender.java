...
public class PicRender extends PictureFrameBuffer {
    ...
    public void draw(boolean rotate, int size, float x, float y, int ang, HudPosType dir, float alpha) {
        ...
        AllMusicClient.context.guiRenderState.submitGuiElement(new BlitRenderState(RenderPipelines.GUI_TEXTURED, TextureSetup.singleTexture(rotate ? rotateTexture.getTextureView() : sourceTexture.getTextureView()), matrix, x0, y0, x1, y1, u0, u1, v0, v1, color, AllMusicClient.context.scissorStack.peek()));
    }
}
